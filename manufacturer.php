...
<div class="wrapper">
        ...
        <div class="row">
          <div class="col-md-4">
              <div class="card">
                  ...
                  <?php else: ?>
                    <div class="card-header bg-info">Add new manufacturer</div>
                   <div class="card-body">
                      <form  method="post">
                        <div class="row">
                          <div class="form-group col-md-12">
              ...
              <div class="col-md-8">
                  ...
                  <tbody>
                        <?php 
                          $rowCount = 0;
                          $stmt = "SELECT * FROM tbl_manufacturer ORDER by manu_id DESC ";
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class='btn-group btn-group-sm' role='group' aria-label='Basic example'>
                                    <a href='manufacturer.php?id=$id&name=$name&meth=edit&email=$email&addr=$addr&phone=$phone'  class='btn btn-info'> <i class='fa fa-edit'></i> </a>
  ...
  if(isset($_POST['btnManufacturer'])){
    ...
    $stmt = "SELECT * FROM tbl_manufacturer WHERE name = '$name'";
    $result = mysqli_query($con, $stmt);
    if(mysqli_num_rows($result) == 1){
      ...
      $stmt = "SELECT * FROM tbl_manufacturer WHERE email = '$email'";
      $result = mysqli_query($con, $stmt);
      if(mysqli_num_rows($result) == 1){
        echo "
        <script>
      ...
      ";
        ...
        $stmt = "INSERT into  tbl_manufacturer (name, address, email, phone_number, reg_date)";
  ...
  if(isset($_POST['btnUpdateManu'])){
    ...
    $regdate = date('Y-m-d');
    $id = $_GET['id'];
    $stmt = "UPDATE tbl_manufacturer SET name = '$name', email = '$email', phone_number='$phone', address='$addr' WHERE manu_id = '$id'";
    $result = mysqli_query($con, $stmt);
    if($result){
      header('location: manufacturer.php');
    }
